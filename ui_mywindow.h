...
public:
    ...
    void setupUi(QMainWindow *MyWindow)
    {
        ...
        stackedWidget->setGeometry(QRect(20, -10, 1301, 631));
        page = new QWidget();
        ...
        grades_button_2->setGeometry(QRect(330, 550, 131, 41));
        teachers_button_2 = new QPushButton(page_3);
        teachers_button_2->setObjectName(QStringLiteral("teachers_button_2"));
        teachers_button_2->setGeometry(QRect(110, 270, 181, 81));
        studen_button_2 = new QPushButton(page_3);
        studen_button_2->setObjectName(QStringLiteral("studen_button_2"));
        studen_button_2->setGeometry(QRect(110, 390, 181, 81));
        ...
        listWidget_2->setGeometry(QRect(320, 110, 731, 431));
        class_button_2 = new QPushButton(page_3);
        class_button_2->setObjectName(QStringLiteral("class_button_2"));
        class_button_2->setGeometry(QRect(110, 160, 181, 81));
        pushButton_13 = new QPushButton(page_3);
        pushButton_13->setObjectName(QStringLiteral("pushButton_13"));
        pushButton_13->setGeometry(QRect(670, 550, 131, 41));
        ...
        pushButton_14->setGeometry(QRect(850, 550, 131, 41));
        pushButton_15 = new QPushButton(page_3);
        pushButton_15->setObjectName(QStringLiteral("pushButton_15"));
        pushButton_15->setGeometry(QRect(500, 550, 131, 41));
    ...
    void retranslateUi(QMainWindow *MyWindow)
    {
        ...
        label->setText(QApplication::translate("MyWindow", "love of money", Q_NULLPTR));
        ...
        teachers_button_2->setText(QApplication::translate("MyWindow", "Teacher", Q_NULLPTR));
        studen_button_2->setText(QApplication::translate("MyWindow", "Student", Q_NULLPTR));
        logout_button_2->setText(QApplication::translate("MyWindow", "Logout", Q_NULLPTR));
        class_button_2->setText(QApplication::translate("MyWindow", "Class", Q_NULLPTR));
        pushButton_13->setText(QApplication::translate("MyWindow", "Del", Q_NULLPTR));
        label_4->setText(QApplication::translate("MyWindow", "TEACHER PAGE", Q_NULLPTR));
        pushButton_14->setText(QApplication::translate("MyWindow", "WOO", Q_NULLPTR));
        pushButton_15->setText(QApplication::translate("MyWindow", "Add", Q_NULLPTR));
