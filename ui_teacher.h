...
public:
    ...
    void setupUi(QMainWindow *Teacher)
    {
        ...
        TeachWidget = new QListWidget(page);
        TeachWidget->setObjectName(QStringLiteral("TeachWidget"));
        TeachWidget->setGeometry(QRect(50, 100, 256, 192));
        listWidget_2 = new QListWidget(page);
        listWidget_2->setObjectName(QStringLiteral("listWidget_2"));
        listWidget_2->setGeometry(QRect(390, 100, 256, 192));
        ...
        pushButton_3->setGeometry(QRect(430, 360, 93, 28));
        pushButton_4 = new QPushButton(page);
        pushButton_4->setObjectName(QStringLiteral("pushButton_4"));
        pushButton_4->setGeometry(QRect(550, 360, 93, 28));
        ...
        Mclasses = new QPushButton(page);
        Mclasses->setObjectName(QStringLiteral("Mclasses"));
        Mclasses->setGeometry(QRect(20, 360, 75, 23));
    ...
    void retranslateUi(QMainWindow *Teacher)
    {
        ...
        Mclasses->setText(QApplication::translate("Teacher", "classes", Q_NULLPTR));
