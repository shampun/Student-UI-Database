...
public:
    ...
    void setupUi(QMainWindow *Teacher)
    {
        ...
        TeacherWidget = new QListWidget(page);
        TeacherWidget->setObjectName(QStringLiteral("TeacherWidget"));
        TeacherWidget->setGeometry(QRect(55, 91, 301, 201));
    ...
    void retranslateUi(QMainWindow *Teacher)
    {
        ...
        classes->setText(QApplication::translate("Teacher", "classes", Q_NULLPTR));
